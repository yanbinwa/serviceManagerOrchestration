...
public interface IOrchestrationService extends InitializingBean, ServiceLifeCycle
{
    ...
    boolean isRegZnodeExist(String serviceName) throws KeeperException, InterruptedException;
    
    boolean isDepZnodeExist(String serviceGroupName) throws KeeperException, InterruptedException;
    
    ZNodeServiceData getRegZnodeData(String serviceName) throws KeeperException, InterruptedException;
    
    void createRegZnode(String serviceName, ZNodeData zNodeData) throws KeeperException, InterruptedException;
    
    void createDepZnode(String serviceGroupName, ZNodeDependenceData zNodeDependenceData) throws KeeperException, InterruptedException;
    
    void updateDepZnode(String serviceGroupName, ZNodeDependenceData zNodeDependenceData) throws KeeperException, InterruptedException;
    
    void deleteRegZnode(String serviceName) throws InterruptedException, KeeperException;
    
    void deleteDepZnode(String serviceName) throws InterruptedException, KeeperException;
}
