...
//            onLineServiceNameToServiceDataMap = new HashMap<String, ZNodeServiceData>();
...
//                ZNodeServiceData zNodeData = ZNodeDataUtil.getZnodeData(data);
...
//            {
//                ZNodeServiceData value = onLineServiceNameToServiceDataMapCopy.get(childNode);
//                if (value == null)
//                {
...
//                return;
//            }
//            kafkaData = new ZNodeServiceDataImpl("kafkaIp", "kafka", "kafka", -1, "kafkaUrl");
//        }
//        
//        public void start()
//        {
